...
public class GameObjectManager : MonoBehaviour
{
    ...
    private _PlayableAgent _localPlayer;
    ...
    public void CreateLocalPlayer(LocalPlayerViewModel vm)
    {
        var createdObj = Instantiate(Prefab_LocalPlayerView, Root_LocalPlayer.transform);
        var localPlayerView = createdObj.GetComponent<LocalPlayerView>();
        localPlayerView.BindViewModel(vm);
    }

    // 등록과 가져오기
    public void RegisterLocalPlayer(_PlayableAgent localPlayer)
    {
    ...
    private void InitGeneratedEntityObject(int generatedId, GameObject gObj)
    {
        ...
        _2DEnemy gameEntity = gObj.GetComponent<_2DEnemy>();
        if (gameEntity == null)
        {
    ...
    public async UniTaskVoid CreateMonsterObject(string monsterDataId, Transform spawnSpot)
    {
        ...
        var createdObj = await ResourceManager.Inst.InstantiateAsync(monsterData.PrefabPath, Root_Enemy, true);
    ...
    private void AddMonsterObjectOnCreate(GameObject createdObject, string monsterDataId)
    {
        ...
        var monsterComponent = createdObject.GetComponent<BattleAgent>();
    ...
    public BattleAgent GetMonsterObjectByInstanceId(int monsterInstanceId)
    {
