...
public class _2DPlayer : _PlayableAgent
{
    [Header("이동 설정")]
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        var enemyComponent = collision.gameObject.GetComponent<_2DEnemy>();
    ...
    private void CreateProjectileSkillObject()
    {
        ...
        skillProjectileComponent.InitSkillObject2D(0, _lookRight, this.transform.position, 500, tag, OnMonsterCollied);
    }
