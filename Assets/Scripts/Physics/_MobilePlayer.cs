...
public class _MobilePlayerView : MonoBehaviour
{
    [Header("플레이어 설정")]
    ...
    [SerializeField] private _GroundDetector GroundDetector;
    [SerializeField] private _AnimationController AnimController;
